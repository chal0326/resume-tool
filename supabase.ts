  ...
  public: {
    Tables: {
      achievements: {
        ...
        Relationships: [
          {
            foreignKeyName: "achievements_work_history_id_fkey"
      ...
      res_transferable_skills: {
        ...
        Relationships: [
          {
            foreignKeyName: "res_transferable_skills_experience_id_fkey"
            columns: ["experience_id"]
            isOneToOne: false
            referencedRelation: "res_experiences"
            referencedColumns: ["id"]
          },
        ]
      }
      responsibilities: {
        ...
        Relationships: [
          {
            foreignKeyName: "responsibilities_work_history_id_fkey"
            columns: ["work_history_id"]
            isOneToOne: false
            referencedRelation: "work_history"
            referencedColumns: ["id"]
      ...
      skills: {
        ...
        Relationships: [
          {
            foreignKeyName: "skills_work_history_id_fkey"
            columns: ["work_history_id"]
            isOneToOne: false
            referencedRelation: "work_history"
            referencedColumns: ["id"]
