        ...
        messages: [
          ...
          },
          {
            ...
            content: `Extract job title, company, start date, end date, experience, achievements, awards, and certifications from the following resume text. Experience can be acknowledged as a single bullet point under each job therefore there may be multiple experiences under each single job. Based on each experience generate 1 associated transferrable skill the user gained by completing that experience.
                      ...
                      - jobs should be an array of objects with properties: title, company, start_date, end_date.
                      - experiences should be an array of objects with properties: experience_text.
                      - transferrable_skills should be an array of objects with properties: skill_name.                  
                      - achievements should be an array of objects with properties: achievement_name, date_received, description.
                      - awards should be an array of objects with properties: award_name, date_received, description.
                      - certifications should be an array of objects with properties: certification_name, issuing_organization, date_received, description.
